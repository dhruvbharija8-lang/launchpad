...
/* Standalone Live Project offerings for the CAT/OMETs portal — same real
   Prodmark consulting project as the MBA side, framed for CAT/OMET
   aspirants who want a live project/certificate on their profile ahead of
   GDPI and B-school applications. Track:'cat' + cat:'live' makes these show
   up on courses.html under the CAT persona toggle. */
const CAT_LIVE_PROJECTS = [
  { id: 'cat-live-1', Track: 'cat', cat: 'live', type: 'Internship', img: 'images/live-project-1-month.png', badge: null, rating: 4.6, students: 980, level: 'Beginner', hours: '4+ hrs', instr: 'Prodmark Business Consultants', title: 'Live Project — 1 Domain, 1 Month', sub: 'A 1-month real project under Prodmark, 1 domain — 4 hours of domain sessions and 2 ATS-friendly CV points.', tagline: 'Real consulting experience to strengthen your profile before GDPI.', desc: 'Build a genuine consulting credential ahead of your CAT/OMET GDPI rounds and B-school applications, under Prodmark Business Consultants Pvt Ltd. You get 4 hours of sessions on the ins and outs of your chosen domain, followed by a project assignment covering the top 4 focus areas of that domain. On completion you earn 2 ATS-friendly CV/profile points and a Certificate of Completion — solid, concrete talking points for your Personal Interview. Fully online, about 2 hours a day, with flexible submission within 3 months.', price: 4000, mrp: 4500, off: '11% off', featsText: 'Under Prodmark Business Consultants Pvt Ltd\n4 hours of domain sessions + a real project\nTop 4 focus areas of your chosen domain\n2 ATS-friendly CV/profile points + Certificate of Completion\nStrong, concrete talking points for GDPI\nOnline — about 2 hours/day, finish in 1 month\nFlexible dates (submit within 3 months)\nGroup of 2 → 20% off', curriculumText: 'Step 1: Domain Sessions | 4 hours on the ins & outs of your domain\nStep 2: Project Assignment | Top 4 focus areas of the domain\nStep 3: Execution | About 2 hrs/day under Prodmark mentors\nStep 4: Submission & Certificate | 2 ATS-friendly CV points + Certificate of Completion', compCvSlots: '—', compMockPIs: '—', compLiveProject: '1 Month (Prodmark)', compCasePrep: '—', compCanva: '—', compCertificate: '✓ (Prodmark)' },
  { id: 'cat-live-1-2mo', Track: 'cat', cat: 'live', type: 'Internship', img: 'images/live-project-2-months.png', badge: null, rating: 4.7, students: 640, level: 'Intermediate', hours: '8+ hrs', instr: 'Prodmark Business Consultants', title: 'Live Project — 1 Domain, 2 Months', sub: 'A 2-month real project under Prodmark, 1 domain — 8 hours of domain sessions and 5 ATS-friendly CV points.', tagline: 'Go deeper into one domain over 2 months, before GDPI.', desc: 'The 2-month version of our single-domain Live Project under Prodmark Business Consultants Pvt Ltd, built for CAT/OMET aspirants who want a deeper, more substantial profile credential. You get 8 hours of sessions on your chosen domain, followed by a fuller project covering the complete area set. On completion you earn 5 ATS-friendly CV/profile points and a Certificate of Completion. Fully online — about 2 hours a day — with flexible submission within 3 months.', price: 6500, mrp: 7000, off: '7% off', featsText: 'Under Prodmark Business Consultants Pvt Ltd\n1 domain — 8 hours of domain sessions + a real project\nComplete area set for your chosen domain\n5 ATS-friendly CV/profile points + Certificate of Completion\nStrong, concrete talking points for GDPI\nOnline — about 2 hours/day, finish in 2 months\nFlexible dates (submit within 3 months)\nGroup of 2 → 20% off', curriculumText: 'Step 1: Domain Sessions | 8 hours on the ins & outs of your domain\nStep 2: Core Project | Full area set for your chosen domain\nStep 3: Execution | About 2 hrs/day under Prodmark mentors\nStep 4: Submission & Certificate | 5 ATS-friendly CV points + Certificate of Completion', compCvSlots: '—', compMockPIs: '—', compLiveProject: '2 Months, 1 Domain (Prodmark)', compCasePrep: '—', compCanva: '—', compCertificate: '✓ (Prodmark)' },
  { id: 'cat-live-2', Track: 'cat', cat: 'live', type: 'Internship', img: 'images/live-project-2-months.png', badge: null, rating: 4.7, students: 520, level: 'Intermediate', hours: '8+ hrs', instr: 'Prodmark Business Consultants', title: 'Live Project — 2 Domains, 1 Month', sub: 'A 1-month real project under Prodmark, any 2 domains — 4 hours of sessions and 2 ATS-friendly CV points per domain.', tagline: 'Cover two domains at once, in a single month.', desc: 'Pick any 2 domains and get a focused 1-month Live Project under Prodmark Business Consultants Pvt Ltd for each — 4 hours of domain sessions and a project assignment per domain. On completion you earn 2 ATS-friendly CV/profile points per domain (4 total) and a Certificate of Completion — broader, well-rounded talking points for your GDPI rounds. Fully online, about 2 hours a day per domain, with flexible submission within 3 months.', price: 7500, mrp: 7999, off: '6% off', featsText: 'Under Prodmark Business Consultants Pvt Ltd\nAny 2 domains of your choice\n4 hours of domain sessions + a real project, per domain\n2 ATS-friendly CV points per domain (4 total) + Certificate of Completion\nBroader talking points across 2 domains for GDPI\nOnline — about 2 hours/day per domain, finish in 1 month\nFlexible dates (submit within 3 months)\nGroup of 2 → 20% off', curriculumText: 'Step 1: Domain Sessions | 4 hours per domain on the ins & outs of each\nStep 2: Project Assignment | Top focus areas for each of your 2 domains\nStep 3: Execution | About 2 hrs/day per domain under Prodmark mentors\nStep 4: Submission & Certificate | 2 ATS-friendly CV points per domain + Certificate of Completion', compCvSlots: '—', compMockPIs: '—', compLiveProject: '1 Month, 2 Domains (Prodmark)', compCasePrep: '—', compCanva: '—', compCertificate: '✓ (Prodmark)' },
  { id: 'cat-live-2-2mo', Track: 'cat', cat: 'live', type: 'Internship', img: 'images/live-project-2-months.png', badge: null, rating: 4.8, students: 310, level: 'Advanced', hours: '16+ hrs', instr: 'Prodmark Business Consultants', title: 'Live Project — 2 Domains, 2 Months', sub: 'A 2-month real project under Prodmark, any 2 domains — 8 hours of sessions and 5 ATS-friendly CV points per domain.', tagline: 'The deepest dual-domain consulting experience we offer.', desc: 'Pick any 2 domains and get a full 2-month Live Project under Prodmark Business Consultants Pvt Ltd for each — 8 hours of domain sessions and a complete project covering the full area set, per domain. On completion you earn 5 ATS-friendly CV/profile points per domain (10 total) and a Certificate of Completion — the strongest possible profile credential to walk into your GDPI rounds with. Fully online — about 2 hours a day per domain — with flexible submission within 3 months.', price: 11500, mrp: 11999, off: '4% off', featsText: 'Under Prodmark Business Consultants Pvt Ltd\nAny 2 domains of your choice\n8 hours of domain sessions + a full real project, per domain\n5 ATS-friendly CV points per domain (10 total) + Certificate of Completion\nThe strongest possible profile credential for GDPI\nOnline — about 2 hours/day per domain, finish in 2 months\nFlexible dates (submit within 3 months)\nGroup of 2 → 20% off', curriculumText: 'Step 1: Domain Sessions | 8 hours per domain on the ins & outs of each\nStep 2: Core Project | Full area set for each of your 2 domains\nStep 3: Execution | About 2 hrs/day per domain under Prodmark mentors\nStep 4: Submission & Certificate | 5 ATS-friendly CV points per domain + Certificate of Completion', compCvSlots: '—', compMockPIs: '—', compLiveProject: '2 Months, 2 Domains (Prodmark)', compCasePrep: '—', compCanva: '—', compCertificate: '✓ (Prodmark)' }
];
